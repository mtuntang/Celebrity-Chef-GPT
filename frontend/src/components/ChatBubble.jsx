...
function ChatBubble({ text, chefName }) {
  return (
    <div className="flex items-start gap-2.5">
      ...
      <div className="flex flex-col w-full max-w-[320px] leading-1.5 p-4 border-gray-300 bg-gray-300 rounded-e-xl rounded-es-xl dark:bg-gray-700">
        <div className="flex items-center space-x-2 rtl:space-x-reverse">
          <span className="text-sm font-semibold text-gray-900 dark:text-white">
            {chefName}
          </span>
        </div>
        <p className="text-sm font-serif py-2.5 text-gray-900 dark:text-white">
          {text}
        </p>
      </div>
    </div>
